...
export default function Navbar(): JSX.Element {
  ...
  return (
    <nav className="px-5 py-7 flex justify-between items-center bg-transparent">
      <div>
      ...
      <button
        className="p-1 cursor-pointer hover:bg-gray-700 rounded-lg duration-200 text-white outline-none"
